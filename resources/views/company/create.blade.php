    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-md sm:rounded-lg p-8 mb-20">
                ...
                {{-- أضفنا autocomplete="off" هنا لمنع المتصفح من ملء البيانات تلقائياً --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="owner_email" id="owner_email" value="{{ old('owner_email') }}" 
                                       ...
                                       autocomplete="off"
                                       class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400 @error('owner_email') border-red-500 @else border-gray-300 @enderror">
                                @error('owner_email') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                            </div>

                            <div class="relative">
                                <label for="owner_password" class="block text-gray-600 text-sm font-medium mb-1">Password</label>
                                <div class="relative flex items-center">
                                    {{-- استخدام new-password يخبر المتصفح أن هذا ليس حقل تسجيل دخول معتاد --}}
